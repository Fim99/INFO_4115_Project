...
import { View, Text, TouchableOpacity, SafeAreaView, StatusBar, Image,
} from "react-native";
  ...
  const controls = [
    {
      ...
      icon: fanIcon,
      description:
        "Allows you to control your temperature, fan speed and operation mode",
    ...
    },
    {
      ...
      icon: ScheduleIcon,
      description:
        "Schedule a date, time and temperature where you want your AC to turn on",
    ...
    },
    {
      ...
      icon: EnergyIcon,
      description:
        "View your energy usage and cost throughout the day, and even historical data",
