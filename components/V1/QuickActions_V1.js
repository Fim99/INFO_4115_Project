  ...
  return (
    <View style={styles.container}>
              ...
              styles.thumb,
              {
                transform: [{
                  translateX: slideAnim.interpolate({
                    inputRange: [0, 1],
                    outputRange: [4, styles.toggleBackground.width - styles.thumb.width - 4]
                  })
                }]
              }
            ]}
      ...
      >
        ...
        <Text style={styles.scheduleTimeText}>Scheduled At: {scheduledTime}</Text>
      </TouchableOpacity>

      {/* Preset Buttons */}
      <TouchableOpacity style={styles.presetButton}>
        <Text style={styles.presetText}>Cold Preset 1</Text>
        <Text style={styles.presetSubText}>Enables cooling mode and low temperature</Text>
      </TouchableOpacity>

      <TouchableOpacity style={styles.presetButton}>
        <Text style={styles.presetText}>Cold Preset 2</Text>
        <Text style={styles.presetSubText}>Enables Fan mode with medium temperature</Text>
      </TouchableOpacity>
